...
@section('title','About Bangla Edit')
{{--menu--}}
@section('about','side-menu--active')
@section('subOpen','menu__sub-open')
@section('aboutBangla','side-menu--active')
{{--title header--}}
@section('link','About')
@section('subLink','Bangla Edit')
...
@section('mainContent')
    ...
    <div class="intro-y inbox box mt-5">
        <form action="{{ route('bangla.update',$about->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
