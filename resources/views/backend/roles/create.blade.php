...
@section('roleCreate','side-menu--active')
@section('link','Role')
...
@section('mainContent')
    ...
    <!-- END: Top Bar -->
        <div class="intro-y flex items-center mt-8">
            ...
            @canany(['role.all'])
                <a class="button text-white bg-theme-1 shadow-md mr-2" href="{{ route('roles.index') }}">All Role</a>
            @endcanany
        </div>
                        ...
                        <div class="preview">
                            <form action="{{ route('roles.store') }}" method="post" class="validate-form">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" class="input w-full border mt-2" placeholder="e.g: editor" minlength="2" required>
                                    @error('name')
                                ...
                                @if(!empty($permissions))
                                    <div class="mt-3">
                                        ...
                                        <div class="flex items-center text-gray-700 mt-2">
                                            ...
                                            <label class="cursor-pointer select-none" for="">All</label>
                                        </div>
                                    </div>
                                    <br>
                                    <hr>
                                        ...
                                        <div class="grid grid-cols-12 gap-6 mt-5">
                                            ...
                                            <div class="intro-y col-span-6 lg:col-span-6 role-{{ $i }}-management-checkbox">
                                                ...
                                                @foreach($permissions as $permission)
                                                    <div class="flex items-center text-gray-700 mt-2">
                                                        <input type="checkbox" name="permissions[]" value="{{ $permission->name }}" class="input border mr-2">
                                ...
                                <button type="submit" class="button bg-theme-1 text-white mt-5">Add New Role</button>
                            </form>
                        </div>
                    </div>
                </div>
