...
@section('mainContent')
    @include('backend.layouts._alert')
        ...
        <div class="px-5 sm:px-5 mt-5 pt-5 border-t border-gray-200">
            <form action="{{ route('news_category.update',$category->id) }}" method="post" enctype="multipart/form-data">
                 @csrf
                @method('PUT')
        <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
            ...
            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                <button type="submit" class="button w-50 justify-center block bg-theme-1 text-white ml-2">Update News Category</button>
                <br><br>
            </div>
        </div>
