...
@section('title','About English Edit')
{{--menu--}}
@section('about','side-menu--active')
@section('subOpen','menu__sub-open')
@section('aboutEnglish','side-menu--active')
{{--title header--}}
@section('link','About')
@section('subLink','English Edit')
...
@section('mainContent')
    ...
    <div class="intro-y inbox box mt-5">
        <form action="{{ route('english.update',$about->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
