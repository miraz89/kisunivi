...
@section('teamlCreate','side-menu--active')
{{--title header--}}
@section('link','Team')
        ...
        <form action="{{ route('team.store') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="p-5" id="vertical-form">
            <div class="preview">
                <div>
                    <label>Title</label>
                    <input type="text" name="title" value="{{ old('title') }}"class="input w-full border mt-2" placeholder="Team Title" required>
                </div>
                @error('title')
                ...
                <div>
                    ...
                    <input type="text" name="img_title" value="{{ old('img_title') }}"class="input w-full border mt-2" placeholder="Img Title" required>
                </div>
                @error('img_title')
                <div class="text-danger mb-3 text-theme-6">{{ $message }}</div>
                @enderror
                ...
                <div>
                    ...
                    <input type="number" name="position" value="{{ old('position') }}"class="input w-full border mt-2" placeholder="Position" required>
                </div>
                @error('position')
                <div class="text-danger mb-3 text-theme-6">{{ $message }}</div>
                @enderror
